...
describe('CodeDeploy', () => {
  ...
  describe('.buildFnDeploymentGroup', () => {
    ...
    it('should generate a CodeDeploy::DeploymentGroup resouce for the provided function', () => {
      ...
      _.set(expected, 'Properties.ApplicationName', { Ref: codeDeployAppName });
      _.set(expected, 'Properties.AlarmConfiguration', expectedAlarms);
      _.set(expected, 'Properties.DeploymentConfigName.Fn::Sub[1].ConfigName', deploymentSettings.type);
